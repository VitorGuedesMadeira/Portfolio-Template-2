    ...
    return (
      <section className="microverse-section-container">
        <div className="microverse-information">
          ...
          <p className="microverse-description">Spent 1300+ hours mastering algorithms, data structures, and full-stack development while simultaneously developing projects with <a href="https://en.wikipedia.org/wiki/Ruby_(linguagem_de_programa%C3%A7%C3%A3o)" target="_blank">Ruby</a>, <a href="https://en.wikipedia.org/wiki/Ruby_on_Rails" target="_blank">Rails</a>, <a href="https://en.wikipedia.org/wiki/JavaScript" target="_blank">JavaScript</a>, <a href="https://en.wikipedia.org/wiki/React_(JavaScript_library)" target="_blank">React</a>, and <a href="https://en.wikipedia.org/wiki/Redux_(JavaScript_library)" target="_blank">Redux</a>.</p>
          <p className="microverse-description">Developed skills in remote pair-programming using <a href="https://github.com/VitorGuedesMadeira" target="_blank">GitHub</a>, industry-standard gitflow, and daily standups to communicate and collaborate with international remote developers.</p>
